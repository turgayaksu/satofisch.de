...
export default function MainContainer() {
  return (
    <div className='flex justify-between'>
      <div>
        <h2 className='text-4xl font-semibold mb-4'>Bauarbeiten im Gange</h2>
        <p className='w-3/4 opacity-50 mb-4'>
        ...
        <div className='flex'>
          <input
            type='text'
            className='border border-solid border-1 border-white/20 px-4 py-2 w-80 bg-white/10 text-white placeholder:text-white/30'
