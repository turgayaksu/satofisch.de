  ...
  return (
    <div className='flex flex-col md:flex-row justify-between items-center'>
      <div>
        ...
        <p className='text-justify w-11/12 md:w-3/4 opacity-50 mb-4'>
        ...
        <div className='flex'>
          <input
            type='text'
            className='border border-solid border-1 border-white/20 px-4 py-2 w-40 md:w-80 bg-white/10 text-white placeholder:text-white/30'
