  ...
  return (
    <>
      <div className='text-3xl md:text-7xl mt-8 md:mt-0 font-medium flex justify-between sf-shadow'>
        <div className='mx-2 flex flex-col w-16 md:w-28 justify-center text-center relative after:content-[" "] after:absolute after:w-2 after:h-2 after:rounded-full after:bg-white/20 after:top-1/3 after:-right-3'>
        ...
        <div className='mx-2 flex flex-col w-16 md:w-28 justify-center text-center relative'>
